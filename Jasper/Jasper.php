...
class Jasper
{
    ...
    public function __construct($host = null, $user = null, $pass = null, $ssl = false)
    {
        ...
        try
        {
            $this->rest = new JasperRest($this->host, $ssl);
    ...
    public function login($user = null, $pass = null)
    {
        ...
        try
        {
            ...
            if ($resp['header']['http_code'] != 200)
            {
                throw new \Exception('Connection failed, HTTP code: ' . $resp['header']['http_code']);
            }
        }
        catch (\Exception $e)
        {
    ...
    public function deleteResource($resource)
    {
        ...
        if (($resource->getUriString() == '/' || $resource->getUriString() == '/reports' || $resource->getUriString() == '/reports/') && $this->customerMode === true)
        {
